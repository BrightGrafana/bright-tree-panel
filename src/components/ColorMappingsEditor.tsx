...
import { Button, ColorPicker, Icon, Input, Select, Tooltip } from '@grafana/ui';
import { ColorMappings, MappingType, ValueMap, ValueMapping } from '../types';
import { SelectableValue } from '@grafana/data';

interface Props {
  value: ColorMappings;
  onChange: (value: ColorMappings) => void;
}
...
export const ColorMappingsEditor: React.FC<Props> = ({ value = { valueMappings: [] }, onChange }) => {
